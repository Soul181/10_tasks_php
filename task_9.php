                        ...
                        <div class="panel-content">
                            <div class="panel-content">
								...
								<?php 
									...
									if ($conn && isset($_POST['form'])) {
									$massage =  htmlspecialchars($_POST['form']); // обработка функцией спец символов
									$sql = "INSERT INTO `task_9`(`text`) VALUES ($massage)";// Запрос в БД, Добавляем запись в БД
